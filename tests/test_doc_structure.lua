...
test("README.md's Reporting a bug section is the standard's text with /wg, and links nowhere", function()
...
test("every settings tab the README sends a player to exists in the schema", function()
    ...
    -- under Notify" while the same feature's release-notes row said Chat, and `notify.delay`
