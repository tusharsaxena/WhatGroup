...
names appear inside comments at `core/WhatGroup.lua:16`, `:26` and `:684`, which describe the hook
...
`modules/Frame.lua:428`, added 2026-08-06. Everything else above is one-shot or self-unregistering.
