...
names appear inside comments at `core/WhatGroup.lua:16`, `:26`, `:96`, `:299`, `:771` and `:853`
...
| `core/WhatGroup.lua:856` | `self:ScheduleTimer(…)` | **One-shot** AceTimer, armed once per group join, for the notify delay. Not repeating. |
