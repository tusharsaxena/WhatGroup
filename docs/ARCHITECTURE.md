...
teleport cooldown countdown at `modules/Frame.lua:491`, a 1-second `ScheduleRepeatingTimer` added
...
at 1154 and `core/WhatGroup.lua` at 1117. `tests/_kit/test_layout_cap.lua` holds this census to
