...
| The shared library, its five seams and the degraded install | `libs/LibKa0s/`, `core/CoreSetup.lua`, `core/MediaSetup.lua`, `core/DebugLogSetup.lua`, `settings/OptionsSetup.lua`, `settings/Slash.lua` | this file, below |
